...
function draw_canvas() {
  ...
  for (var x1=0; x1<5; x1++) { x_rr[x1]=0.425/x_num/8; } // 10 % of group
  for (var y1=0; y1<4; y1++) { y_rr[y1]=0.425/y_num/8; } // 10 % of group
  for (var x1=5; x1<x_num; x1++) { x_rr[x1]=0.425/x_num/8; } // 90 % of group
  for (var y1=4; y1<y_num; y1++) { y_rr[y1]=0.425/y_num/8; } // 90 % of group
  for (var z1=0; z1<4; z1++) { z_rr[z1]=0.25/4/8; }
  // game bord のクリア
  var n1=0;
